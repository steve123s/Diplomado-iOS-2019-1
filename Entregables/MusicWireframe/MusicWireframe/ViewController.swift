...
//  MusicWireframe
//
//  Created by Servicio Esteban  on 05/10/18.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        reverseBackground.layer.cornerRadius = 30.0
        reverseBackground.clipsToBounds = true
        reverseBackground.alpha = 0.0
        
        playPauseBackground.layer.cornerRadius = 30.0
        playPauseBackground.clipsToBounds = true
        playPauseBackground.alpha = 0.0
        
        forwardBackground.layer.cornerRadius = 30.0
